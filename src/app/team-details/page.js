          ...
          <div className="container">
            <div className="team-details__top">
              <div className="team-details__top-bg">
                <div className="team-details__top-shape-1 float-bob">
                  <img
                    src="assets/images/shapes/team-details-top-shape-1.png"
                    alt=""
                  />
                </div>
                  ...
                  <div className="team-details__top-right">
                    ...
                    <ul className="team-details__top-points list-unstyled">
                      ...
                      <li>
                        <span>Email:</span>
                        <p>
                          <Link href="mailto:sonchoyhelp@gmail.com">
                            sonchoyhelp@gmail.com
                          </Link>
                        </p>
                      </li>
                      <li>
                    ...
                    <div className="team-details__social">
                      ...
                      <Link href="#" className="team-details__social-color-2">
                        <span className="icon-twitter"></span>
                      </Link>
                      <Link href="#" className="team-details__social-color-3">
                        <span className="icon-instagram"></span>
                      </Link>
                      <Link href="#" className="team-details__social-color-4">
            ...
            <div className="team-details__bottom">
              ...
              <div className="team-details__contact-box">
                <h3 className="team-details__contact-title">
                  Let’s Get in Touch
                </h3>
