                ...
                <li className="wow fadeInUp" data-wow-delay="200ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="health-insurance">Health Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
                ...
                <li className="wow fadeInUp" data-wow-delay="300ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="car-insurance">Car Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
                ...
                <li className="wow fadeInUp" data-wow-delay="400ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="family-insurance">Travels Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
                ...
                <li className="wow fadeInUp" data-wow-delay="500ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="home-insurance">Home Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
          ...
          <div className="container">
            <div className="services-two__bottom-inner">
              ...
              <h3 className="services-two__bottom-title">
                Compare & Get
                <br /> Your Insurance in Right Way
              </h3>
